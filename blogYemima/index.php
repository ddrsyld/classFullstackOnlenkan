<?php 
    ...
    $last_post = mysqli_fetch_array(mysqli_query($connect, "SELECT * FROM post INNER JOIN users ON post.users_id=users.id ORDER BY post.id DESC LIMIT 1"));
?>
    ...
    <header class="py-5">
        <div class="container">
            ...
            <p class="text-secondary text-center text-capitalize">
                Lorem ipsum dolor, sit amet consectetur adipisicing elit. Atque eaque consectetur quia, magnam hic quasi fuga animi porro nostrum magni!
            </p>
        ...
        <div class="container">
            <a href="detail.php?title=<?= $last_post['slug']?>" class="row align-items-center hero-post">
                ...
                <div class="col-md-6">
                    ...
                    <h2 class="hero-post-title text-primary text-capitalize mt-5">
                        <?= $last_post['title']?>
                    </h2>
                    ...
                    <div class="d-flex align-items-center gap-3">
                        <img src="assets/img/users/<?= $last_post['photo']?>"  class="avatar rounded-circle">
                        <div class="profile">
    ...
    <section class="py-5">
        <div class="container">
            <div class="row">
                <?php
                    $query = mysqli_query($connect, "SELECT * FROM post INNER JOIN users ON post.users_id=users.id ORDER BY post.id DESC");
                ...
                <div class="col-md-4">
                    <a href="detail.php?title= <?= $data['slug'] ?>" class="card card-post border-0 rounded-3 mb-3">
                        ...
                        <div class="card-body">
                            <span class="bg-light rounded p-2 fw-bold text-primary category">The Newest</span>
                            <h2 class="card-post-title text-primary text-capitalize mt-5">
                                <?= $data['title'] ?>
                            </h2>
                            <p class="text-secondary">
    ...
    <script src="assets/vendors/dist/js/bootstrap.bundle.min.js"></script>
